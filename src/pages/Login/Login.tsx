...
export default function Login() {
    ...
    return (
      ...
      <div className="card shadow login-page-content p-5 m-3">
        <h4 className="mb-4 fw-semibold text-center">Login</h4>
        <div>
        ...
        <span>Doesn't have an account? <NavLink to="/register" className="text-decoration-none">Register</NavLink></span>
      </div>
    </div>
    )
}